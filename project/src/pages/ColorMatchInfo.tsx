...
import { ArrowLeft, Play, BookOpen, Sparkles, Palette } from "lucide-react";
import { DotLottieReact } from '@lottiefiles/dotlottie-react';
import Navbar from "../Components/Navbar";
import bg from "../assets/game3.png";
import learnThumb from "../assets/game3.png";
import playThumb from "../assets/game3.png";

const ColorMatchInfo = () => {
  const navigate = useNavigate();

  // Voice Function for Kids
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans overflow-x-hidden">
      ...
      <div className="relative flex-grow flex flex-col items-center pt-32 pb-20 px-6">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-sky-900/30 via-slate-900/50 to-slate-900/90" />
        </div>
        ...
        <div className="relative z-10 max-w-6xl w-full mx-auto">
          ...
          <div className="mb-14 text-center md:text-left">
            <h1 className="text-5xl md:text-7xl font-extrabold text-white drop-shadow-2xl tracking-tight mb-3">
              Color <span className="text-sky-300">Match</span>
            </h1>

            <div className="flex items-center gap-3 justify-center md:justify-start text-white/85 text-lg font-medium">
              <Palette className="text-amber-300" size={22} />
              <span>Learn colors visually</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            {/* Learn Card */}
            <div 
              onMouseEnter={() => speak("Color Matching: Learning Phase")} 
              className="group bg-white rounded-[2rem] shadow-xl overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-500 border-4 border-transparent hover:border-sky-200 cursor-pointer"
            >
              ...
              <div className="p-8 flex flex-col items-center">
                <div className="w-full h-44 mb-6 bg-sky-50/50 rounded-2xl flex justify-center items-center relative overflow-hidden group-hover:bg-sky-50 transition-colors">
            ...
            {/* Play Card */}
            <div 
              onMouseEnter={() => speak("Color Matching: Playing Phase")}
              className="group bg-white rounded-[2rem] shadow-xl overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-500 border-4 border-transparent hover:border-amber-200 cursor-pointer"
            >
              <div className="relative aspect-[16/9] overflow-hidden">
                <img
                  src={playThumb}
              ...
              <div className="p-8 flex flex-col items-center">
                <div className="w-full h-44 mb-6 bg-amber-50/50 rounded-2xl flex justify-center items-center relative overflow-hidden group-hover:bg-amber-50 transition-colors">
                  <div className="transform group-hover:-translate-y-2 transition-transform duration-500 ease-in-out">
                    <DotLottieReact
