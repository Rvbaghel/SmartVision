  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans overflow-x-hidden">
      ...
      <div className="relative flex-grow flex flex-col items-center pt-32 pb-20 px-6">
        {/* Background - Math/Numbers Theme */}
        <div className="absolute inset-0 z-0">
          <img src={bg} alt="" className="w-full h-full object-cover blur-sm brightness-75" />
          <div className="absolute inset-0 bg-gradient-to-b from-blue-900/30 via-slate-900/50 to-slate-900/90" />
        </div>
        ...
        <div className="relative z-10 max-w-6xl w-full mx-auto">
          ...
          <div className="mb-14 text-center md:text-left">
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start text-white/85 text-lg font-medium">
              <Hash className="text-cyan-300" size={24} />
              <span>Let's count to twenty!</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            {/* Learn Card */}
            <div 
              onMouseEnter={() => speak("Number Counting: Learning Phase")} 
              className="group bg-white rounded-[2rem] shadow-xl overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-500 border-4 border-transparent hover:border-blue-200 cursor-pointer"
            >
              ...
              <div className="p-8 flex flex-col items-center">
                <div className="w-full h-44 mb-6 bg-blue-50/50 rounded-2xl flex justify-center items-center relative overflow-hidden group-hover:bg-blue-50 transition-colors">
            ...
            {/* Play Card */}
            <div 
              onMouseEnter={() => speak("Number Counting: Playing Phase")}
              className="group bg-white rounded-[2rem] shadow-xl overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-500 border-4 border-transparent hover:border-cyan-200 cursor-pointer"
            >
              <div className="relative aspect-[16/9] overflow-hidden">
                <img
                  src={playThumb}
                  alt="Play numbers game"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
                <div className="absolute bottom-6 left-6 flex items-center gap-3 text-white">
              ...
              <div className="p-8 flex flex-col items-center">
                <div className="w-full h-44 mb-6 bg-cyan-50/50 rounded-2xl flex justify-center items-center relative overflow-hidden group-hover:bg-cyan-50 transition-colors">
                  <div className="transform group-hover:-translate-y-2 transition-transform duration-500 ease-in-out">
                    <DotLottieReact
