...
import { ArrowLeft, Play, BookOpen, Sparkles, Brain } from "lucide-react";
import { DotLottieReact } from '@lottiefiles/dotlottie-react';
import Navbar from "../components/Navbar";
// Using game6.png as requested
import bg from "../assets/game6.png"; 
import learnThumb from "../assets/game6.png";
import playThumb from "../assets/game6.png";

const MemoryMatchInfo = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans overflow-x-hidden">
      ...
      <div className="relative flex-grow flex flex-col items-center pt-32 pb-20 px-6">
        {/* Background - Memory/Brain Theme */}
        <div className="absolute inset-0 z-0">
          <img src={bg} alt="" className="w-full h-full object-cover blur-sm brightness-75" />
          <div className="absolute inset-0 bg-gradient-to-b from-purple-900/30 via-slate-900/50 to-slate-900/90" />
        </div>
        ...
        <div className="relative z-10 max-w-6xl w-full mx-auto">
          ...
          <div className="mb-14 text-center md:text-left">
            <h1 className="text-5xl md:text-7xl font-extrabold text-white drop-shadow-2xl tracking-tight mb-3">
              Memory <span className="text-purple-400">Match</span>
            </h1>
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start text-white/85 text-lg font-medium">
              ...
              <span>Boost your brain power!</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            {/* Learn Card */}
            <div 
              onMouseEnter={() => speak("Memory Match: Learning Phase")} 
              className="group bg-white rounded-[2rem] shadow-xl overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-500 border-4 border-transparent hover:border-purple-200 cursor-pointer"
            >
              <div className="relative aspect-[16/9] overflow-hidden">
                <img
                  src={learnThumb}
                  alt="Learn memory matching"
              ...
              <div className="p-8 flex flex-col items-center">
                <div className="w-full h-44 mb-6 bg-purple-50/50 rounded-2xl flex justify-center items-center relative overflow-hidden group-hover:bg-purple-50 transition-colors">
            ...
            {/* Play Card */}
            <div 
              onMouseEnter={() => speak("Memory Match: Playing Phase")}
              className="group bg-white rounded-[2rem] shadow-xl overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-500 border-4 border-transparent hover:border-indigo-200 cursor-pointer"
            >
              <div className="relative aspect-[16/9] overflow-hidden">
                <img
                  src={playThumb}
                  alt="Play memory game"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
                <div className="absolute bottom-6 left-6 flex items-center gap-3 text-white">
              ...
              <div className="p-8 flex flex-col items-center">
                <div className="w-full h-44 mb-6 bg-indigo-50/50 rounded-2xl flex justify-center items-center relative overflow-hidden group-hover:bg-indigo-50 transition-colors">
                  <div className="transform group-hover:-translate-y-2 transition-transform duration-500 ease-in-out">
                    <DotLottieReact
...
export default MemoryMatchInfo;